    ...
    <script language="javascript" type="text/javascript">
        ...
        function feeTypeChange(type) {
            ...
            if (type == 1) {
                ...
                inputArray[7].value = "";
                var psel = document.getElementById("monthly");
                psel.value = '1';
            }
            else if (type == 2) {
                ...
                var psel = document.getElementById("package");
                psel.value = "2";
            }
            else if (type == 3) {
                inputArray[5].readOnly = true;
                ...
                inputArray[7].readOnly = false;
                inputArray[7].className = "width100";
                var psel = document.getElementById("timeBased");
                psel.value = "3";
            }
        }
    </script>
...
<div id="main">
    ...
    <form action="fee_modi" method="" class="main_form">
        ...
        <div class="input_info fee_type">
            ...
            <%--<input type="radio" name="radFeeType" id="package" onclick="feeTypeChange(2);"value="${radFeeType}" />--%>
            <%--<label for="package">套餐</label>--%>
            <%--<input type="radio" name="radFeeType" id="timeBased" onclick="feeTypeChange(3); "  value="${radFeeType}"/>--%>
        ...
        <div class="input_info">
            <input type="text" value="${unitCost}" class="width100"/>
